---
title: "Why Every Sequel Audit Starts with the Same 28 Checks"
description: "Consistency is what makes findings comparable and credible — and what stops auditors from skipping the boring ones because the site looked fine at first glance."
category: methodology
length: medium
publishOrder: 11
linkedinReleaseOrder: 9
...
1. **SEO Fundamentals** (6 checks). Page title, meta description, canonical tag, robots meta tag, heading structure, inner-page canonicals.
2. **Social Sharing and Open Graph** (3 checks). OG image, Open Graph tags, Twitter Cards.
3. **Performance and Page Speed** (5 checks). Time to first byte, total load time, image optimization, third-party services impact, script loading.
4. **Schema and Structured Data** (3 checks). Structured data presence, schema connectivity, rich result types available but missing.
5. **Analytics and Tracking Integrity** (3 checks). GA4 present, duplicate pixel firing, third-party inventory.
6. **Security and Crawlability** (4 checks). Robots.txt, HTTPS/SSL, external link noopener, llms.txt.
7. **Accessibility** (2 checks). Image alt text, HTML lang attribute.
8. **Platform and AI Discoverability** (2 checks). Website builder identification, AI-Powered Search readiness.
